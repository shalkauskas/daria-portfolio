      ...
      <ProgressTracker.Container>
        ...
        <CaseContainer
          ...
          <div ref={interviewsRef}>
            ...
            <Stack direction="column" gap="1.5rem">
              ...
              <Typography>
                ...
                framed the objectives as well as the list of questions for each
                one of them (please see below). Besides the specific questions
                about the product features we also made sure to include few
                introductory questions as well as more general ones, so users
                have an opportunity to give us a better context on how they
              ...
              <Typography>
                ...
                via Microsoft Teams. Recording interviews not only helped us to
                keep a live conversation, focus on answers and come up with
                follow-up questions but also to make sure we are not losing any
                feedback. Luckily, all the participants were kind enough to give
                us a consent for video recording. Using the AI tool, Otter.ai, I
                transcribed all the interviews and created documentation of the
                responses that can be easily accessed by other team members and
                stored at the company’s repository. The documentation includes
                transcripts and the Excel spreadsheet where I organized the
              ...
              <Typography>
                ...
                tendency and ranked them by the amount of feedback included. The
                top tendencies got the names and the problem statements.
                Comparing the list of problem statements created for both Survey
                and User Interview findings helped me estimate the importance of
                problems from the user's standpoint. As you can see from the
                clusters below, the order of problems importance has slightly
          ...
          <div ref={outcomesRef}>
            ...
            <Stack direction="column" gap="1rem" css={{ marginBottom: '2rem' }}>
              <Typography variant="h3">Conclusions</Typography>
              <Typography>
                The lesson that I have learned during our research is to always
                stay open-minded. The survey results gave us an idea of what
                problems our users are facing and what functionality they would
                like to see in our product to make their workflows more
                efficient. However, listening to what our users had to say
                during the interviews not only made us think of some of the
                existing features at the completely new angle and understand all
                the why's behind new feature requests but also opened our eyes
                on the areas of the product we did not even consider and their
                importance at the overall user experience. For, example, one of
                the key findings was that users would like to have a dashboard
                that would provide them a quick overview of their progress and
                suggest the action they need take next while the current
                dashboard was designed to accelerate the process of logging
                hours and did not give users an idea of what’s going across the
                product.
              </Typography>
              ...
              <Typography>
                ...
                upcoming redesign. Once we create the prototype, we will conduct
                usability testing with users we recruited during the interviews.
              </Typography>
            </Stack>
            <ViewNext />
          </div>
