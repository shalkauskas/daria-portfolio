...
export function Research() {
  return (
    <Stack gap="2rem" direction="column">
      ...
      <Typography>
        I started the research with identifying personas and reached out to the
        main channel of communication with the clients – Product Manager. The
        Product Manager helped me to single out two primary personas based on
        her client knowledge – Residency Program Director and Residency
      ...
      <Typography>
        ...
        softwares. Once I collected all the information and presented it to the
        product team we had a brainstorming session. During that meeting we came
        up with the list of improvements that we need to make to help our
        personas achieve their goals. The list includes the following:
      </Typography>
      <List>
        <List.Item>
        ...
        <List.Item>
          Include the timeline chart that will allow users to have a high level
          view on the applicant’s career path.
        </List.Item>
        <List.Item>
        ...
        <List.Item>
          Enable users to favorite the information that plays the most important
      ...
      <Typography>
        ...
        few Residency conferences where our leadership presented the redesign so
        this project was our chance to stand out and attract new clients.
      </Typography>
    </Stack>
  );
}
