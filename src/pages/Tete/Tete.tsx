        ...
        <CaseContainer>
          <div ref={problemRef}>
            <Preview
              desktop={
                <PreviewOverlayContainer>
                  <Image src={desktop} objectFit="scale-down" />
                  <CenteredDesktopVideo
                    controls
            ...
            <Stack
              ...
              <Stack gap="1rem" direction="column">
                ...
                <Typography>
                  ...
                  since 1999. The main purpose of having a website for
                  Tete-A-Tete is providing the information necessary for
                  visiting the salon. However, the surveys have shown that users
                  often have difficulties navigating the website and have no
                  other choice but to contact the salon in order to get info.
                </Typography>
              </Stack>
              {/* Benchmark &  Solutions*/}
              <Stack
              ...
              <OutcomesContainer gap="1rem" direction="column">
                ...
                <List>
                  ...
                  <List.Item>
                    It inspired stylists to document their best works in order
